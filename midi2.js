...
var gridBtnLEDcolor = JSON.parse('{"btn":[{"red":15,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0},{"red":0,"grn":0,"blu":0}]}');
...
var trackNumIndex = 0;
function patternEvent(data, eventIdIndex, time) {
  this.startTimeOffset = time;
  this.data = data;
...
function trackPattern(patLength = 16, bpm = 120, beats = 4) {
  ...
  this.addEvent = function(data, timeOffset) {
...
var track = [new defaultTrack(), new defaultTrack(), new defaultTrack(), new defaultTrack()];
track.forEach(function(track, index) {
  track.addPattern(16, 110, 4);
})

track.forEach(function(track, index) {
  track.patterns["id_0"].addEvent([144, 117, 0], 0);
})
track[1].patterns["id_0"].addEvent([144, 116, 0], 500);
track[1].patterns["id_0"].addEvent([144, 116, 0], 1000);
track[1].patterns["id_0"].addEvent([144, 116, 0], 1500);
track[2].patterns["id_0"].addEvent([144, 115, 0], 0);
//
// ind = track[0].addPattern(16,120);
// track[0].patterns[ind].addEvent([144,95,32]);
// track[0].patterns[ind].addEvent([144,94,32]);
// track[0].patterns[ind].addEvent([144,93,32]);
// console.log(track[0].patterns[ind].events["id_0"].data);
//
// track.push(new defaultTrack());
// ind = track[1].addPattern(16,120);
// ind2 = track[1].addPattern(16,120);
// ind3 = track[1].addPattern(16,120);
// track[1].patterns[ind].addEvent([144,95,32]);
// track[1].patterns[ind2].addEvent([144,94,32]);
// track[1].patterns[ind3].addEvent([144,93,32]);
// track[1].patterns[ind].addEvent([144,93,32]);
// track[1].patterns[ind2].addEvent([144,93,32]);
// track[1].patterns[ind3].addEvent([144,93,32]);
// track[1].patterns[ind].addEvent([144,93,32]);

// console.log(track[0].patterns[0].events[0].id);
// console.log(track[0].patterns[0].events[1].id);
// console.log(track[0].patterns[0].events[2].id);



var seq = {}; // object to hold state of things
seq.mode = {};
seq.mode.current = "Step";
...
seq.state.lastOLEDupdateTime = new Date().getTime();
...
var seqLoop_ipcSocket;
var polyrythmGen_ipcSocket;
  ...
  function() {
    ipc.server.on(
      ...
      function(data, socket) {
        ...
        ipc.server.emit(socket,'seq.stateVar',seq.track);
      }
    );
    ipc.server.on(
      'socket.disconnected',
    ...
    switch (message[0]) {
      case 144: // note-on event
        if (message[1] >= 54 && message[1] <= 117) { // grid button
          ...
          // get cuurent color of button
          let btnColorIndex = message[1] - 54;
          let currentBtnColor = gridBtnLEDcolor.btn[btnColorIndex];
          // create new dimmed values
          let dimColor = {};
          dimColor.red = currentBtnColor.red / 15;
          dimColor.grn = currentBtnColor.grn / 15;
          dimColor.blu = currentBtnColor.blu / 15;
          dimColor.red &= 0x7f;
          dimColor.grn &= 0x7f;
          dimColor.blu &= 0x7f;
          // build sysex message
          btnLEDSysEx = [0xf0, 0x47, 0x7f, 0x43, 0x65, 0x00, 0x04, message[1] - 54, dimColor.red, dimColor.grn, dimColor.blu, 0xF7];
          // send it to the Fire
      ...
      case 128: // note-off event
        if (message[1] >= 54 && message[1] <= 117) { // grid button
          btnLEDSysEx = [0xf0, 0x47, 0x7f, 0x43, 0x65, 0x00, 0x04, message[1] - 54, (gridBtnLEDcolor.btn[message[1]-54].red) & 0x7F, (gridBtnLEDcolor.btn[message[1]-54].grn) & 0x7F, (gridBtnLEDcolor.btn[message[1]-54].blu) & 0x7F, 0xF7];
          fireMidiOut.sendMessage(btnLEDSysEx);
        }
        switch (message[1]) {
          case 53: // rec button
...
function updateAllNotGridBtnLEDS() {
  ...
  // pattern up btn LED
  message[1] = 31;
  message[2] = notGridBtnLEDS[0];
  fireMidiOut.sendMessage(message);

  // pattern dwn btn LED
  message[1] = 32;
  message[2] = notGridBtnLEDS[1];
  fireMidiOut.sendMessage(message);

  // browser btn LED
  message[1] = 33;
  message[2] = notGridBtnLEDS[2];
  fireMidiOut.sendMessage(message);


  // grid left btn LED
  message[1] = 34;
  message[2] = notGridBtnLEDS[3];
  fireMidiOut.sendMessage(message);


  // grid right btn LED
  message[1] = 35;
  message[2] = notGridBtnLEDS[4];
  fireMidiOut.sendMessage(message);

  // track one btn LED
  message[1] = 36;
  message[2] = notGridBtnLEDS[5];
  fireMidiOut.sendMessage(message);
  ...
  // track 3 btn LED
  message[1] = 38;
  message[2] = notGridBtnLEDS[7];
  fireMidiOut.sendMessage(message);

  // track 4 btn LED
  message[1] = 39;
  message[2] = notGridBtnLEDS[8];
  fireMidiOut.sendMessage(message);

  // track 1 selected LED
  message[1] = 40;
  message[2] = notGridBtnLEDS[9];
  fireMidiOut.sendMessage(message);

  // track 2 selected LED
  message[1] = 41;
  message[2] = notGridBtnLEDS[10];
  fireMidiOut.sendMessage(message);

  // track 3 selected LED
  message[1] = 42;
  message[2] = notGridBtnLEDS[11];
  fireMidiOut.sendMessage(message);

  // track 4 selected LED
  message[1] = 43;
  message[2] = notGridBtnLEDS[12];
  fireMidiOut.sendMessage(message);

  // step btn LED
  message[1] = 44;
  message[2] = notGridBtnLEDS[13];
  fireMidiOut.sendMessage(message);

  // note btn LED
  message[1] = 45;
  message[2] = notGridBtnLEDS[14];
  fireMidiOut.sendMessage(message);

  // drum btn LED
  message[1] = 46;
  message[2] = notGridBtnLEDS[15];
  fireMidiOut.sendMessage(message);

  // perform btn LED
  message[1] = 47;
  message[2] = notGridBtnLEDS[16];
  fireMidiOut.sendMessage(message);

  // shift btn LED
  message[1] = 48;
  message[2] = notGridBtnLEDS[17];
  fireMidiOut.sendMessage(message);

  // alt btn LED
  message[1] = 49;
  message[2] = notGridBtnLEDS[18];
  fireMidiOut.sendMessage(message);

  // pat/song btn LED
  message[1] = 50;
  message[2] = notGridBtnLEDS[19];
  fireMidiOut.sendMessage(message);

  // play btn LED
  message[1] = 51;
  message[2] = notGridBtnLEDS[20];
  fireMidiOut.sendMessage(message);

  // stop btn LED
  message[1] = 52;
  message[2] = notGridBtnLEDS[21];
  fireMidiOut.sendMessage(message);

  // rec btn LED
  message[1] = 53;
  message[2] = notGridBtnLEDS[22];
  fireMidiOut.sendMessage(message);
