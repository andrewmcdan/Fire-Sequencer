...
// var nativeLib = require('../rust/rust-fire-lib/native');

const { EventEmitter: RustChannel } = require('../rust/rust-fire-lib/native');
...
class MyEventEmitter extends EventEmitter {
  constructor() {
    ...
    const loop = () => {
      ...
      if(this.dataNeedsSending){
        channel.recData(this.dataToSend);
        this.dataNeedsSending = false;
      }
